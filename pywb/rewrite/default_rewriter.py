...
from pywb.rewrite.regex_rewriters import JSLocationOnlyRewriter, JSNoneRewriter, JSWombatProxyRewriter, JSWombatProxyESMRewriter
...
class DefaultRewriter(BaseContentRewriter):
    DEFAULT_REWRITERS = {
        ...
        'js-esm': JSWombatProxyESMRewriter,
